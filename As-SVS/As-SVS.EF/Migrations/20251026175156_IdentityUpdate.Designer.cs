...
namespace AsSVS.EF.Migrations
{
    ...
    [Migration("20251026175156_IdentityUpdate")]
            ...
            modelBuilder.Entity("As_SVS.Core.Models.Admin", b =>
                {
                    b.HasOne("As_SVS.Core.Models.Person", "Person")
                        .WithOne("Admin")
                        .HasForeignKey("As_SVS.Core.Models.Admin", "PersonId")
                        .IsRequired()
            ...
            modelBuilder.Entity("As_SVS.Core.Models.Student", b =>
                {
                    ...
                    b.HasOne("As_SVS.Core.Models.Person", "Person")
                        .WithOne("Student")
                        .HasForeignKey("As_SVS.Core.Models.Student", "PersonId")
                        .IsRequired()
            ...
            modelBuilder.Entity("As_SVS.Core.Models.Teacher", b =>
                {
                    ...
                    b.HasOne("As_SVS.Core.Models.Person", "Person")
                        .WithOne("Teacher")
                        .HasForeignKey("As_SVS.Core.Models.Teacher", "PersonId")
                        .IsRequired()
